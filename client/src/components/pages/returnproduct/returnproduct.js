...
import { getOrderbyCustomerNumber, getOrderbyOrderNumber } from "../../../actions/returnproduct";
...
class ReturnProduct extends Component {
  ...
  productBox = () => {
    let productarray = [];
    let { barcodes } = this.props.order[0];
...
export default connect(mapStateToProps, {
  getOrderbyCustomerNumber, getOrderbyOrderNumber, getCustomer, getAllProducts,
